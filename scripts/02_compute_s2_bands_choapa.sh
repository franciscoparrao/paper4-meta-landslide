#!/usr/bin/env bash
# Paper 4 — Sequential per-band Sentinel-2 composite for Choapa via Earth Search.
# Same pattern as 02_compute_s2_bands_taltal.sh.
...
DEM="$ROOT/factors/choapa/dem_30m.tif"
OUTDIR="$ROOT/factors/choapa/imagery"
LOGDIR="$ROOT/factors/choapa/imagery/logs"
BBOX="-71.569759,-32.280876,-70.208812,-31.140430"
